module.exports = {
  ...
  "global": function* (ctx) {
    ...
    ctx.scope.set("g1", 1);
    ctx.scope.set("getVals", ctx.KRLClosure(ctx, function* (ctx, getArg) {
      return {
    ...
    ctx.scope.set("mapped", yield ctx.callKRLstdlib("map", [
      ...
      2,
      3
    ], ctx.KRLClosure(ctx, function* (ctx, getArg) {
      ctx.scope.set("n", getArg("n", 0));
