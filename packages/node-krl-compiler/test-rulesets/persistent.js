module.exports = {
  ...
  "global": function* (ctx) {
    ctx.scope.set("getName", ctx.KRLClosure(ctx, function* (ctx, getArg) {
      return yield ctx.modules.get(ctx, "ent", "name");
    }));
    ctx.scope.set("getAppVar", ctx.KRLClosure(ctx, function* (ctx, getArg) {
      return yield ctx.modules.get(ctx, "app", "appvar");
    }));
    ctx.scope.set("getUser", ctx.KRLClosure(ctx, function* (ctx, getArg) {
      return yield ctx.modules.get(ctx, "ent", "user");
    }));
    ctx.scope.set("getUserFirstname", ctx.KRLClosure(ctx, function* (ctx, getArg) {
