...
var grammar = {
    ...
    {"name": "RuleActionBlock$ebnf$1", "symbols": [tok_every], "postprocess": id},
    ...
    {"name": "RuleActionBlock", "symbols": [tok_if, "Expression", tok_then, "RuleActionBlock$ebnf$1", tok_OPEN_CURLY, "RuleActionBlock$ebnf$2", tok_CLSE_CURLY], "postprocess": ruleActionBlock([1], [3, "src"], [5])},
    ...
    {"name": "RuleActionBlock", "symbols": [tok_every, tok_OPEN_CURLY, "RuleActionBlock$ebnf$3", tok_CLSE_CURLY], "postprocess": ruleActionBlock([], [0, "src"], [2])},
    {"name": "RuleActionBlock$ebnf$4", "symbols": ["RuleAction"]},
    {"name": "RuleActionBlock$ebnf$4", "symbols": ["RuleActionBlock$ebnf$4", "RuleAction"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "RuleActionBlock", "symbols": [tok_choose, "Expression", tok_OPEN_CURLY, "RuleActionBlock$ebnf$4", tok_CLSE_CURLY], "postprocess": ruleActionBlock([1], [0, "src"], [3])},
    ...
    {"name": "declaration_list_body", "symbols": ["Declaration"], "postprocess": idArr},
