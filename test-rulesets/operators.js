module.exports = {
  ...
  "global": function* (ctx) {
    ...
    ctx.scope.set("results", {
      ...
      "num_as_str": yield ctx.callKRLstdlib("as", [
        1.05,
        "String"
      ]),
      "regex_as_str": yield ctx.callKRLstdlib("as", [
        new RegExp("blah", "i"),
        "String"
      ]),
      "isnull": [
      ...
      "10.sprintf": yield ctx.callKRLstdlib("sprintf", [
        10,
        "< %d>"
      ]),
      ".capitalize()": yield ctx.callKRLstdlib("capitalize", ["Hello World"]),
      ".decode()": yield ctx.callKRLstdlib("decode", ["[3, 4, 5]"]),
      ".extract": yield ctx.callKRLstdlib("extract", [
        "This is a string",
        new RegExp("(s.+).*(.ing)", "")
      ]),
      ".lc()": yield ctx.callKRLstdlib("lc", ["Hello World"]),
      ".match true": yield ctx.callKRLstdlib("match", [
        "Something",
        new RegExp("^S.*g$", "")
      ]),
      ".match false": yield ctx.callKRLstdlib("match", [
        "Someone",
        new RegExp("^S.*g$", "")
      ]),
      ".ord()": yield ctx.callKRLstdlib("ord", ["Hello"]),
      ".replace": yield ctx.callKRLstdlib("replace", [
        "Hello William!",
        new RegExp("will", "i"),
        "Bill"
      ]),
      ".split": yield ctx.callKRLstdlib("split", [
        "a;b;c",
        new RegExp(";", "")
      ]),
      ".sprintf": yield ctx.callKRLstdlib("sprintf", [
        "Jim",
        "Hello %s!"
      ]),
      ".substr(5)": yield ctx.callKRLstdlib("substr", [
        "This is a string",
        5
      ]),
      ".substr(5, 4)": yield ctx.callKRLstdlib("substr", [
        "This is a string",
        5,
        4
      ]),
    ...
    ctx.scope.set("returnMapAfterKlog", ctx.mkFunction(function* (ctx, getArg, hasArg) {
      return yield ctx.callKRLstdlib("klog", [
        { "a": 1 },
        "hi:"
      ]);
    }));
    ctx.scope.set("returnArrayAfterKlog", ctx.mkFunction(function* (ctx, getArg, hasArg) {
      return yield ctx.callKRLstdlib("klog", [
        [
          1,
          2
