  ...
  "init": async function ($rsCtx, $mkCtx) {
    ...
    $rs.when($ctx.krl.SelectWhen.e("engine_ui:box"), async function ($event, $state, $last) {
      try {
        ...
        const validateColor3 = $ctx.krl.Function(["v"], async function (v4) {
          const c4 = await klog1($ctx, [
            await as1($ctx, [
              v4,
              "String"
            ]),
        ...
        if (await $stdlib["><"]($ctx, [
          ...
          await $ctx.rsCtx.putEnt("backgroundColor", await validateColor3($ctx, [await $stdlib["get"]($ctx, [
              $ctx.module("event")["attrs"]($ctx),
              "backgroundColor"
            ])]));
      } finally {
    ...
    $rs.when($ctx.krl.SelectWhen.e("engine_ui:new"), async function ($event, $state, $last) {
      try {
        ...
        if ($fired)
          ...
          $ctx.log.debug("not fired");
        if ($fired) {
          await $ctx.rsCtx.raiseEvent("wrangler", "new_child_request", await put1($ctx, [
            await put1($ctx, [
              $ctx.module("event")["attrs"]($ctx),
              "name",
              $name$3
    ...
    return {
      ...
      "query": {
        "box": async function (query, qid) {
          $ctx.setQuery(Object.assign({}, query, { "qid": qid }));
          try {
            return await box2($ctx, query.args);
          } finally {
            $ctx.setQuery(null);
          }
        },
        "uiECI": async function (query, qid) {
          $ctx.setQuery(Object.assign({}, query, { "qid": qid }));
          try {
            return await uiECI2($ctx, query.args);
          } finally {
            $ctx.setQuery(null);
          }
        },
        "pico": async function (query, qid) {
          $ctx.setQuery(Object.assign({}, query, { "qid": qid }));
          try {
            return await pico2($ctx, query.args);
          } finally {
            $ctx.setQuery(null);
          }
        },
        "logs": async function (query, qid) {
          $ctx.setQuery(Object.assign({}, query, { "qid": qid }));
          try {
            return await logs2($ctx, query.args);
          } finally {
            $ctx.setQuery(null);
          }
        },
        "testingECI": async function (query, qid) {
          $ctx.setQuery(Object.assign({}, query, { "qid": qid }));
          try {
            return await testingECI2($ctx, query.args);
          } finally {
            $ctx.setQuery(null);
          }
        },
