...
export declare const RESERVED_WORDS_ENUM: {
    defaction: boolean;
    function: boolean;
    return: boolean;
    not: boolean;
...
export interface EventOperator extends BaseNode {
    type: "EventOperator";
    op: "or" | "and" | "before" | "then" | "after" | "between" | "not between" | "any";
...
export declare const TIME_PERIOD_ENUM: {
    day: boolean;
    days: boolean;
    hour: boolean;
    hours: boolean;
...
export declare const LEVEL_ENUM: {
    error: boolean;
    warn: boolean;
    info: boolean;
    debug: boolean;
