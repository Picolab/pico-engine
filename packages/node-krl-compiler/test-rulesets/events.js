module.exports = {
  ...
  "global": function* (ctx) {
    ctx.scope.set("getOnChooseFired", ctx.KRLClosure(ctx, function* (ctx, getArg) {
      return yield ctx.modules.get(ctx, "ent", "on_choose_fired");
    }));
    ctx.scope.set("getNoActionFired", ctx.KRLClosure(ctx, function* (ctx, getArg) {
      return yield ctx.modules.get(ctx, "ent", "no_action_fired");
    }));
    ctx.scope.set("getSentAttrs", ctx.KRLClosure(ctx, function* (ctx, getArg) {
      return yield ctx.modules.get(ctx, "ent", "sent_attrs");
    }));
    ctx.scope.set("getSentName", ctx.KRLClosure(ctx, function* (ctx, getArg) {
