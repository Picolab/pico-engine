...
test("time module", async function (t) {
  ...
  var now1 = await time.now(ctx, [{ tz: "Australia/Sydney" }]);
  ...
  await terr(
    ...
    ctx,
    [[]],
    "TypeError: time:now was given [Array] instead of an opts map"
  );
  ...
  await terr(
    ...
    ctx,
    ["67342"],
    "Error: time:new was given an invalid date string (67342)"
  );
  ...
  await terr(
    ...
    ctx,
    [67342, 5],
    "TypeError: time:add was given 67342 instead of a date string"
  );
  await terr(
    "add",
    ctx,
    ["67342", 5],
    "Error: time:add was given an invalid date string (67342)"
  );
  await terr(
    "add",
    ctx,
    ["2017-01-01", []],
    "TypeError: time:add was given [Array] instead of a spec map"
  );

  var xTime = "2010-10-06T18:25:55";
  t.is(await time["strftime"](ctx, [xTime, "%F %T"]), "2010-10-06 18:25:55");
  t.is(
    await time["strftime"](ctx, [xTime, "%A %d %b %Y"]),
    "Wednesday 06 Oct 2010"
  );
  t.is(await time["strftime"](ctx, [xTime, "year month"]), "year month");
  ...
  await terr(
    ...
    ctx,
    [67342],
    "Error: time:strftime needs a fmt string"
  );
  await terr(
    "strftime",
    ctx,
    [67342, "%F %T"],
    "TypeError: time:strftime was given 67342 instead of a date string"
  );
  await terr(
    "strftime",
    ctx,
    ["67342", "%F %T"],
    "Error: time:strftime was given an invalid date string (67342)"
  );
  await terr(
    "strftime",
    ctx,
    ["1967342", ["%A %d %b %Y"]],
    "TypeError: time:strftime was given [Array] instead of a fmt string"
  );
});
